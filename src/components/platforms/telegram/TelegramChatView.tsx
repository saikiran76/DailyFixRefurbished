...
const ChatView = ({ selectedContact, onContactUpdate, onClose }) => {
  ...
  const renderHeader = () => {
    return (
      <div className="flex items-center p-3 bg-[#0f1211] border-b border-blue-400 sticky top-0 z-10">
  ...
  return (
    <div className="chat-view-container telegram-chat-view flex flex-col h-full bg-neutral-900 relative overflow-x-hidden rounded-lg w-full">
      {!selectedContact?.id ? (
