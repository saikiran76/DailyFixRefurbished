...
const ContactItem = memo(({ contact, onClick, isSelected }) => {
  ...
  return (
    ...
    >
      {showTooltip && (
        <div className="absolute right-2 top-2 flex gap-1 bg-[#2a3942] p-1 rounded-md z-10">
                <Button
                  onClick={handleEdit}
                  variant="ghost"
                  size="icon"
      ...
      <div className="flex-1 min-w-0">
        {isEditing ? (
          ...
          <>
            ...
            <div className="text-gray-400 text-sm truncate mt-1">{contact.last_message}</div>
          </>
        )}
      </div>
    </div>
...
const WhatsAppContactList = ({ onContactSelect, selectedContactId }) => {
  ...
  return (
    <Card className="flex flex-col h-full w-full border-none shadow-none rounded-lg bg-[#111b21] relative">
      <CardHeader className="p-3 bg-[#202c33] border-b border-gray-800">
        <div className="flex items-center justify-between">
          <CardTitle className="text-white font-bold text-lg">WhatsApp Chats</CardTitle>
      ...
      <div className="p-2 border-b border-gray-800">
        <div className="relative">
          ...
          <Input
            ...
            className="w-full bg-[#202c33] text-white pl-10 pr-10 py-2 rounded-lg border-none focus:outline-none focus:ring-0 placeholder-gray-400 h-9"
          />
          {searchQuery && (
            <Button
      ...
      <CardContent className="flex-1 overflow-y-auto p-0">
        ...
        {refreshRequired && !loading && (
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center z-20">
            <div className="bg-[#2a3942] p-6 rounded-lg text-center max-w-sm shadow-lg">
